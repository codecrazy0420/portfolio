# James Perez - Portfolio Website

This is a personal portfolio website of James Perez built with React to showcase my experience, projects, skills, and certifications.
...
1. Clone the repository
   ...
   ```
   git clone https://github.com/codecrazy0420/portfolio.git
   cd portfolio
   ```
