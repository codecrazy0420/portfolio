...
const Contact = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch('https://formsubmit.co/el/xebese', {
        method: 'POST',
        headers: {
            ...
            <div className="mt-6 space-y-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <a href="https://www.linkedin.com" target="_blank" rel="noopener noreferrer" className="hover:text-primary transition-colors">
                  linkedin.com/in/codecrazy0420
                </a>
              </div>
              <div className="flex items-center gap-3">
                <FaGithub className="text-primary" />
                <a href="https://github.com/codecrazy0420" target="_blank" rel="noopener noreferrer" className="hover:text-primary transition-colors">
                  github.com/codecrazy0420
                </a>
              </div>
            </div>
          </div>
